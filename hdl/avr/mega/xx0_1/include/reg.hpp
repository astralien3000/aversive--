...
namespace HDL {
  ...
  struct GPIO_ModuleRegisters {
    ...
    static constexpr MemoryMapping::Register8<Groups::PIN>  PIN  = BASE_ADDR + 0x20;
    static constexpr MemoryMapping::Register8<Groups::DDR>  DDR  = BASE_ADDR + 0x21;
    static constexpr MemoryMapping::Register8<Groups::PORT> PORT = BASE_ADDR + 0x22;
  };
  ...
  template<u8 ID>
  struct GPIO : public GPIO_ModuleRegisters<0x03*ID, 8>, public GPIO_ModuleFields<0x03*ID, 8> {};

  template<>
  struct GPIO<6> : public GPIO_ModuleRegisters<0x03*6, 6>, public GPIO_ModuleFields<0x03*6, 6> {};
