...
template<> inline Register<8, 18>::Register(void) : reg_size(1), reg{(u8*)&DDRD} {}
template<> inline Register<8, 19>::Register(void) : reg_size(1), reg{(u8*)&PORTA} {}
template<> inline Register<8, 20>::Register(void) : reg_size(1), reg{(u8*)&PORTB} {}
template<> inline Register<8, 21>::Register(void) : reg_size(1), reg{(u8*)&PORTC} {}
template<> inline Register<8, 22>::Register(void) : reg_size(1), reg{(u8*)&PORTD} {}
template<> inline Register<8, 23>::Register(void) : reg_size(1), reg{(u8*)&PINA} {}
template<> inline Register<8, 24>::Register(void) : reg_size(1), reg{(u8*)&PINB} {}
template<> inline Register<8, 25>::Register(void) : reg_size(1), reg{(u8*)&PINC} {}
template<> inline Register<8, 26>::Register(void) : reg_size(1), reg{(u8*)&PIND} {}
