...
template<> inline Config<8, 19>::Config(void) : conf{( 1 << TOIE1 )} {}
template<> inline Register<8, 8>::Register(void) : reg_size(1), reg{(u8*)&TIFR} {}
template<> inline Register<8, 11>::Register(void) : reg_size(1), reg{(u8*)&UCSR0A} {}
...
template<> inline Register<8, 12>::Register(void) : reg_size(3), reg{(u8*)&UCSR0A, (u8*)&UCSR0B, (u8*)&UCSR0C} {}
template<> inline Config<8, 30>::Config(void) : conf{0, 0, ( 1 << UMSEL0 )} {}
template<> inline Config<8, 31>::Config(void) : conf{0, ( 1 << TXEN0 ), 0} {}
template<> inline Config<8, 32>::Config(void) : conf{0, ( 1 << RXEN0 ), 0} {}
...
template<> inline Config<8, 42>::Config(void) : conf{0, ( 0 << UCSZ2 ), ( 0 << UCSZ1 ) | ( 0 << UCSZ0 )} {}
template<> inline Config<8, 43>::Config(void) : conf{0, ( 0 << UCSZ2 ), ( 0 << UCSZ1 ) | ( 1 << UCSZ0 )} {}
template<> inline Config<8, 44>::Config(void) : conf{0, ( 0 << UCSZ2 ), ( 1 << UCSZ1 ) | ( 0 << UCSZ0 )} {}
template<> inline Config<8, 45>::Config(void) : conf{0, ( 0 << UCSZ2 ), ( 1 << UCSZ1 ) | ( 1 << UCSZ0 )} {}
template<> inline Config<8, 46>::Config(void) : conf{0, ( 1 << UCSZ2 ), ( 1 << UCSZ1 ) | ( 1 << UCSZ0 )} {}
template<> inline Config<8, 39>::Config(void) : conf{0, 0, 0} {}
template<> inline Config<8, 40>::Config(void) : conf{0, 0, ( 1 << UPM01 )} {}
template<> inline Config<8, 41>::Config(void) : conf{0, 0, ( 1 << UPM01 ) | ( 1 << UPM00 )} {}
template<> inline Config<8, 47>::Config(void) : conf{0, 0, 0} {}
template<> inline Config<8, 48>::Config(void) : conf{0, 0, ( 1 << USBS0 )} {}
template<> inline Register<8, 13>::Register(void) : reg_size(2), reg{(u8*)&UBRR0L, (u8*)&UBRR0H} {}
template<> inline Register<8, 14>::Register(void) : reg_size(1), reg{(u8*)&UDR0} {}
template<> inline Register<8, 15>::Register(void) : reg_size(2), reg{(u8*)&EEARL, (u8*)&EEARH} {}
template<> inline Register<8, 16>::Register(void) : reg_size(1), reg{(u8*)&EEDR} {}
template<> inline Register<8, 17>::Register(void) : reg_size(1), reg{(u8*)&EECR} {}
...
template<> inline Register<8, 18>::Register(void) : reg_size(2), reg{(u8*)&MCUCR, (u8*)&XMCRA} {}
