...
template<> inline Config<8, 27>::Config(void) : conf{0, ( 1 << TXEN0 ), 0} {}
template<> inline Config<8, 28>::Config(void) : conf{0, ( 1 << RXEN0 ), 0} {}
template<> inline Config<8, 29>::Config(void) : conf{0, ( 1 << RXCIE0 ), 0} {}
template<> inline Config<8, 30>::Config(void) : conf{0, ( 1 << TXCIE0 ), 0} {}
template<> inline Config<8, 31>::Config(void) : conf{0, ( 1 << UDRIE0 ), 0} {}
template<> inline Config<8, 32>::Config(void) : conf{( 1 << RXC0 ), 0, 0} {}
template<> inline Config<8, 33>::Config(void) : conf{( 1 << TXC0 ), 0, 0} {}
template<> inline Config<8, 34>::Config(void) : conf{( 1 << UDRE0 ), 0, 0} {}
...
template<> inline Config<8, 35>::Config(void) : conf{0, 0, ( 1 << UMSEL0 )} {}
template<> inline Config<8, 36>::Config(void) : conf{0, 0, 0} {}
template<> inline Config<8, 37>::Config(void) : conf{0, 0, ( 1 << UPM01 )} {}
template<> inline Config<8, 38>::Config(void) : conf{0, 0, ( 1 << UPM01 ) | ( 1 << UPM00 )} {}
template<> inline Config<8, 44>::Config(void) : conf{0, 0, 0} {}
template<> inline Config<8, 45>::Config(void) : conf{0, 0, ( 1 << USBS0 )} {}
