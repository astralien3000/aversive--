...
template<> inline Config<8, 10>::Config(void) : conf{(1 << OCIE0A)} {}
template<> inline Config<8, 11>::Config(void) : conf{(1 << OCIE0B)} {}
template<> inline Config<8, 12>::Config(void) : conf{(1 << TOIE0)} {}
...
template<> inline Config<8, 29>::Config(void) : conf{0, (1 << RXEN0), 0} {}
template<> inline Config<8, 30>::Config(void) : conf{0, (1 << TXEN0), 0} {}
...
template<> inline Config<8, 37>::Config(void) : conf{0, (0 << UCSZ02), (0 << UCSZ01) | (0 << UCSZ00)} {}
template<> inline Config<8, 38>::Config(void) : conf{0, (0 << UCSZ02), (0 << UCSZ01) | (1 << UCSZ00)} {}
template<> inline Config<8, 39>::Config(void) : conf{0, (0 << UCSZ02), (1 << UCSZ01) | (0 << UCSZ00)} {}
template<> inline Config<8, 40>::Config(void) : conf{0, (0 << UCSZ02), (1 << UCSZ01) | (1 << UCSZ00)} {}
template<> inline Config<8, 41>::Config(void) : conf{0, (1 << UCSZ02), (1 << UCSZ01) | (1 << UCSZ00)} {}
template<> inline Config<8, 42>::Config(void) : conf{0, 0, 0} {}
template<> inline Config<8, 43>::Config(void) : conf{0, 0, (1 << UPM01)} {}
template<> inline Config<8, 44>::Config(void) : conf{0, 0, (1 << UPM01) | (1 << UPM00)} {}
