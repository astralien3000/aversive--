...
typedef uint_fast16_t array_t;

static const array_t MAX_ARRAY_SIZE = UINT16_MAX;
...
template<array_t SIZE, typename ElementType>
class Array {
private:
  ElementType element[SIZE];

public:
  static const array_t size = SIZE;
...
template<array_t SIZE, typename T>
