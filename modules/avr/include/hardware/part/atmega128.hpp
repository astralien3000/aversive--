...
template<> inline Config<8, 15>::Config(void) : conf{0, 0, 0} {}
template<> inline Config<8, 16>::Config(void) : conf{(1 << WGM10) | (1 << WGM11), 0, 0} {}
template<> inline Config<8, 17>::Config(void) : conf{0, (1 << WGM12), 0} {}
template<> inline Config<8, 18>::Config(void) : conf{(1 << WGM10) | (1 << WGM11), (1 << WGM12), 0} {}
...
template<> inline Config<8, 29>::Config(void) : conf{(1 << RXC0)} {}
template<> inline Config<8, 30>::Config(void) : conf{(1 << TXC0)} {}
template<> inline Config<8, 31>::Config(void) : conf{(1 << UDRE0)} {}
template<> inline Register<8, 9>::Register(void) : reg_size(3), reg{(u8*)&UCSR0A, (u8*)&UCSR0B, (u8*)&UCSR0C} {}
template<> inline Config<8, 32>::Config(void) : conf{0, 0, (1 << UMSEL0)} {}
template<> inline Config<8, 33>::Config(void) : conf{0, (1 << RXEN0), 0} {}
template<> inline Config<8, 34>::Config(void) : conf{0, (1 << TXEN0), 0} {}
template<> inline Config<8, 35>::Config(void) : conf{0, (1 << RXCIE0), 0} {}
template<> inline Config<8, 36>::Config(void) : conf{0, (1 << TXCIE0), 0} {}
template<> inline Config<8, 37>::Config(void) : conf{0, (1 << UDRIE0), 0} {}
template<> inline Config<8, 38>::Config(void) : conf{(1 << RXC0), 0, 0} {}
template<> inline Config<8, 39>::Config(void) : conf{(1 << TXC0), 0, 0} {}
template<> inline Config<8, 40>::Config(void) : conf{(1 << UDRE0), 0, 0} {}
...
template<> inline Config<8, 47>::Config(void) : conf{0, 0, (1 << UPM01)} {}
template<> inline Config<8, 48>::Config(void) : conf{0, 0, (1 << UPM01) | (1 << UPM00)} {}
template<> inline Config<8, 49>::Config(void) : conf{0, 0, 0} {}
template<> inline Config<8, 50>::Config(void) : conf{0, 0, (1 << USBS0)} {}
...
template<> inline Config<8, 54>::Config(void) : conf{(1 << SRE), 0} {}
template<> inline Config<8, 55>::Config(void) : conf{0, (1 << SRW11) | (1 << SRW00)} {}
